...
addon.db.Enchanting = {
	...
	[25124] = {
		...
		itemVendors = {3346, 1318, 15419, 5758, 4228, 5757, 4617, 5158, 3012, },
	},
	[7454] = {
		spellID = 7454,
		minSkill = 45,
	...
	[7793] = {
		...
		sourceItemID = 6349,
		itemSource = sources.Vendors,
		itemVendors = {3346, 5758, 5158, 3012, },
	},
	[7795] = {
		spellID = 7795,
		minSkill = 100,
	...
	[448624] = {
		spellID = 448624,
		requiresSeason = restrictions.SoDPhase3,
		minSkill = 120,
		itemID = 220792,
		reagents = {4470, 10940, },
	...
	[25125] = {
		...
		sourceItemID = 20752,
		itemSource = sources.Vendors,
		itemVendors = {3346, 1318, 15419, 5758, 4228, 5757, 4617, 3012, 5158, },
	},
	[13622] = {
		spellID = 13622,
		minSkill = 150,
	...
	[471400] = {
		...
		minSkill = 310,
		itemID = 232611,
		reagents = {8151, 8152, 14344, 18256, },
		reagentQuantities = {3, 3, 2, 1, },
		source = sources.Item,
		sourceItemID = 232610,
		itemSource = sources.Vendors,
		itemVendors = {14921},
	...
	[463871] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {14344, 16203, 7078, 7080, 7076, 12811, },
		reagentQuantities = {4, 12, 4, 4, 1, 1, },
		source = sources.Item,
		sourceItemID = 228982,
		itemSource = sources.Vendors,
		itemVendors = {11557},
	...
	[1213593] = {
		...
		minSkill = 320,
		itemID = 233990,
		reagents = {234006, 234010, 20725, 234004, 2452, },
		reagentQuantities = {10, 10, 6, 6, 20, },
		source = sources.Item,
		sourceItemID = 234266,
		itemSource = sources.Drop,
	...
	[1213595] = {
		...
		minSkill = 320,
		itemID = 233991,
		reagents = {234006, 234010, 20725, 234003, 234012, },
		reagentQuantities = {10, 10, 4, 10, 10, },
		source = sources.Item,
		sourceItemID = 234267,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213598] = {
		...
		minSkill = 320,
		itemID = 233992,
		reagents = {234007, 234010, 20725, 234003, 234011, },
		reagentQuantities = {10, 5, 4, 10, 10, },
		source = sources.Item,
		sourceItemID = 234268,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213600] = {
		...
		minSkill = 320,
		itemID = 233993,
		reagents = {234003, 234005, 14344, 2459, },
		reagentQuantities = {3, 6, 4, 3, },
		source = sources.Item,
		sourceItemID = 234269,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213603] = {
		...
		minSkill = 320,
		itemID = 233994,
		reagents = {234007, 234010, 20725, 234003, 234012, 234011, },
		reagentQuantities = {10, 5, 6, 10, 10, 10, },
		source = sources.Item,
		sourceItemID = 234270,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213610] = {
		...
		minSkill = 320,
		itemID = 233996,
		reagents = {234011, 234012, 16204, },
		reagentQuantities = {3, 3, 2, },
		source = sources.Item,
		sourceItemID = 234272,
		itemSource = sources.Vendors,
		itemVendors = {15419},
	...
	[1213616] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 16204, 16203, 13458, 234011, 234010, },
		reagentQuantities = {2, 8, 5, 10, 2, 2, },
		source = sources.Item,
		sourceItemID = 233997,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213622] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 14344, 13180, 12735, },
		reagentQuantities = {2, 5, 5, 2, },
		source = sources.Item,
		sourceItemID = 233998,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213626] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 14344, 12753, },
		reagentQuantities = {2, 5, 2, },
		source = sources.Item,
		sourceItemID = 233999,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213628] = {
		...
		minSkill = 320,
		itemID = 234000,
		reagents = {20725, 234008, 234003, 12810, },
		reagentQuantities = {3, 10, 2, 4, },
		source = sources.Item,
		sourceItemID = 234275,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213633] = {
		...
		minSkill = 320,
		itemID = 234001,
		reagents = {20725, 234012, 234003, 12810, },
		reagentQuantities = {3, 10, 2, 3, },
		source = sources.Item,
		sourceItemID = 234276,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1213635] = {
		...
		minSkill = 320,
		itemID = 234002,
		reagents = {20725, 234012, 12810, 234011, 234010, },
		reagentQuantities = {2, 20, 3, 4, 4, },
		source = sources.Item,
		sourceItemID = 234277,
		itemSource = sources.Drop,
		itemSourceDropName = 'Gilded Scarab',
	...
	[1217189] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {14344, 16204, 16203, 7080, 7078, 7082, },
		reagentQuantities = {2, 20, 4, 2, 2, 2, },
		source = sources.Unknown,
	},
	[1217203] = {
		spellID = 1217203,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 16204, 16203, 7082, },
		reagentQuantities = {2, 10, 2, 2, },
		source = sources.Unknown,
	},
	[1219577] = {
		spellID = 1219577,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 16204, 7082, },
		reagentQuantities = {2, 18, 2, },
		source = sources.Unknown,
	},
	[1219578] = {
		spellID = 1219578,
	...
	[1219579] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {14344, 16204, 7082, 7080, },
		reagentQuantities = {6, 18, 1, 1, },
		source = sources.Unknown,
	},
	[1219580] = {
		spellID = 1219580,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {20725, 16204, 12938, 8831, },
		reagentQuantities = {3, 24, 1, 6, },
		source = sources.Unknown,
	},
	[1219581] = {
		spellID = 1219581,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {14344, 16204, 7076, },
		reagentQuantities = {6, 18, 2, },
		source = sources.Unknown,
	},
	[1219586] = {
		spellID = 1219586,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {16203, 16204, 7078, },
		reagentQuantities = {7, 21, 2, },
		source = sources.Unknown,
	},
	[1219587] = {
		spellID = 1219587,
	...
	[1220623] = {
		...
		minSkill = 320,
		itemID = 0,
		reagents = {14344, 16204, 12938, },
		reagentQuantities = {5, 15, 1, },
		source = sources.Unknown,
	},
	[1220624] = {
		spellID = 1220624,
		...
		minSkill = 320,
		itemID = 0,
		reagents = {16203, 16204, 12808, 8831, },
		reagentQuantities = {3, 9, 12, 2, },
		source = sources.Unknown,
	},
}